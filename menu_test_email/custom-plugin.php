 ...
 */
 ...
 function add_menu(){
    add_menu_page("Test Email","Test Email","manage_options","test-email","add_contents","dashicons-email",26);
    add_submenu_page("test-email","Send Email","Send Email","manage_options","test-email","add_contents","dashicons-email-alt2");
    add_submenu_page("test-email","Send Content","Send Content","manage_options","send-content","add_contents2","dashicons-email-alt2");
 }
 ...
 function display_post_content($id, $email){
    if($id){
        ...
        if ($single_post) {
            ...
            $post_author_id = $single_post->post_author;
...
add_action('custom_email_content_action', 'display_post_content',10,2);
...
add_filter('custom_email_content_filter', 'modify_email_content');
